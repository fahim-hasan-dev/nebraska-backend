...
const sendPaymentConfirmationEmail = (data) => {
...
const sendAdminPaymentNotificationEmail = (data) => {
    return {
        to: config_1.default.super_admin.email,
...
const businessUserShipmentInfoEmail = (data) => {
    ...
    <tr>
      <td style="padding:25px 20px;">
        ...
        <div style="text-align:center;margin-top:20px;">
          <a href="${config_1.default.frontend_url}/dashboard"
...
const businessUserRegistrationInviteEmail = (data) => {
    const parcels = data.parcel
        .map((p, i) => `
        <tr>
          <td style="padding:4px 0; color:#555;">Parcel ${i + 1}:</td>
  ...
  <table width="100%" cellpadding="0" cellspacing="0"
    ...
    <tr>
      <td style="padding:25px 20px;">
        ...
        <!-- Register Button -->
        <div style="text-align:center;margin-top:20px;">
          <a href="${config_1.default.frontend_url}/register"
...
const guestLostItemNotificationEmail = (data) => {
    var _a;
    const businessDetails = (_a = data === null || data === void 0 ? void 0 : data.user) === null || _a === void 0 ? void 0 : _a.BusinessDetails;
    const BASE_URL = "https://api.App.com";
    const imagesHtml = Array.isArray(data === null || data === void 0 ? void 0 : data.images) && data.images.length > 0
        ? `
    ...
    <tr>
      <td style="padding:25px 20px;">
        ...
        <div style="text-align:center;margin-top:22px;">
          <a href="${config_1.default.frontend_url}/orders/${data._id}"
...
const businessShippingDetailsUpdateEmail = (data) => {
    return {
        to: data.address_from.email,
...
<body style="margin:0;padding:0;font-family:Inter,Segoe UI,sans-serif;background:#f7f9fc;">
  <table width="100%" cellpadding="0" cellspacing="0"
    ...
    <tr>
      ...
      <a href="${config_1.default.backend_url}/${data.shippingLabel}"
   download
...
const customerShippingDetailsUpdateEmail = (data) => {
    return {
        to: data.address_to.email,
