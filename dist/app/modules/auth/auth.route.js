...
router.post('/change-password', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.FAN, user_1.USER_ROLES.DRIVER), (0, validateRequest_1.default)(auth_validation_1.AuthValidations.changePasswordZodSchema), auth_controller_1.AuthController.changePassword);
router.delete('/delete-account', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.FAN, user_1.USER_ROLES.DRIVER), (0, validateRequest_1.default)(auth_validation_1.AuthValidations.deleteAccount), auth_controller_1.AuthController.deleteAccount);
