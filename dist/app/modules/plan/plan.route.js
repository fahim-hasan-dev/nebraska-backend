...
router.route("/")
    ...
    .get((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.FAN, user_1.USER_ROLES.DRIVER), plan_controller_1.PlanController.getPlan);
router.post("/create-checkout-session/:planId", (0, auth_1.default)(user_1.USER_ROLES.FAN, user_1.USER_ROLES.DRIVER), plan_controller_1.PlanController.createCheckoutSession);
router
    .route("/:id")
