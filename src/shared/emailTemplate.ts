    ...
    <tr>
      <td style="padding:25px 20px;">
        ...
        <div style="text-align:center;margin-top:20px;">
          <a href="${config.frontend_url}/dashboard" style="background:#5690ff;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-size:14px;display:inline-block;box-shadow:0 4px 12px rgba(86,144,255,0.3);">Go to Dashboard</a>
        </div>
      </td>
    </tr>
  </table>
